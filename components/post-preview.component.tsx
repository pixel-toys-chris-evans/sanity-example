...
type PostPreviewProps<TOptions = Record<string, any>> = {
  document: {
...
export function PostPreview({ document }: PostPreviewProps) {
  const post = document.displayed as unknown as Partial<Post> | undefined;
